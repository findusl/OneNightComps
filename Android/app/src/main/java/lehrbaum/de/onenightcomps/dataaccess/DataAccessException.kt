...
open class DataAccessException(
	message: String,
	cause: Throwable? = null
) : RuntimeException(message, cause)

open class NetworkUnavailableException(cause: Throwable? = null) : DataAccessException(
...
open class NotAuthorizedException(message: String) : OperationRejectedException(message)
