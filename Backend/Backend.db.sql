...
game_roles set last_modified = CURRENT_TIMESTAMP WHERE id = NEW.id; END;
...
BEGIN UPDATE game_composition set last_modified = CURRENT_TIMESTAMP WHERE id = NEW.id; END;
...
BEGIN UPDATE game_composition set last_modified = CURRENT_TIMESTAMP WHERE id = NEW.game_composition_id; END;